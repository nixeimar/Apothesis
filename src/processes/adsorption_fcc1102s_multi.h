...
//============================================================================
#ifndef ADSORPTION2SMULTI_H
#define ADSORPTION2SMULTI_H
...
class AdsortpionFCC1102SMulti: public Process
{
public:
    AdsortpionFCC1102SMulti();
    ~AdsortpionFCC1102SMulti() override;
